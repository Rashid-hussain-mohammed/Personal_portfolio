...
const ENTRIES: Entry[] = [
  {
    ...
    detail: "Undergraduate degree in Information Technology.",
  },
  {
    when: "2022",
  ...
  },
  {
    ...
    detail:
      "Master's coursework and project work spanning distributed systems, applied machine learning, and full-stack development.",
  },
  {
    when: "2026—27",
    title: "R&D Intern",
